                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                            @foreach(auth()->user()->notifications as $notification)
                                                @if(empty($notification->read_at))
                                                    <a class="dropdown-item bg-light" href="{{ route('notification.show', $notification->id) }}">
                                                        {{ $notification->data['subject']  }} | <small> {{ $notification->created_at }}</small>
                                                    </a>
                                                @else
                                                    <a class="dropdown-item bg-white" href="{{ route('notification.show', $notification->id) }}">
                                                        {{ $notification->data['subject']  }} | <small> {{ $notification->created_at }}</small>
                                                    </a>
                            ...
                            @can('agent_vente')
                                <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                            @foreach(auth()->user()->notifications as $notification)
                                                @if(empty($notification->read_at))
                                                    <a class="dropdown-item bg-light" href="{{ route('examinerDemande', ['usagerId' => $notification->data['userId'], 'enginId' => $notification->data['enginId'], 'notificationId' => $notification->id, 'demandeTrackId' => $notification->data['demandeTrackId']]) }}">
                                                        {{ $notification->data['subject']  }} | <small> {{ $notification->created_at }}</small>
                                                    </a>
                                                @else
                                                    <a class="dropdown-item bg-white" href="{{ route('examinerDemande', ['usagerId' => $notification->data['userId'], 'enginId' => $notification->data['enginId'], 'notificationId' => $notification->id, 'demandeTrackId' => $notification->data['demandeTrackId']]) }}">
                                                        {{ $notification->data['subject']  }} | <small> {{ $notification->created_at }}</small>
                                                    </a>
