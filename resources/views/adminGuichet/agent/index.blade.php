...
<div class="card px-4">
    ...
    <h3 class="card-title">COMPTES AGENTS</h3>
    </div>
    ...
    <tbody>
        ...
        @for($i=0; $i < count($user_list); $i++)
            <tr>
                ...
                <form action="{{ route('agent.edit', $user_list[$i]['user']->id) }}" id="edit-form" method="get">
                    @csrf
                ...
                <td class="text-danger">
                <form action="{{ route('agent.destroy', $user_list[$i]['user']->id) }}" id="delete-form" method="post">
                    @csrf
                    @method('DELETE')
