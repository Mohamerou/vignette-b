          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Infos Engins</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{ route('guichet.user.engin.update', $engin) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="form-group">
                      <label for="marque">Marque</label>
                      <input value={{ $engin->marque }} name="marque" type="text" class="form-control" id="marque" placeholder="Marque">
                      <input name="user_id" type="hidden" value="{{ $engin->userId }}">
                    </div>
                    <div class="form-group">
                      <label for="modele">Type</label>
                      <input value={{ $engin->modele }} name="modele" type="text" class="form-control" id="modele" placeholder="Modele">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input value={{ $engin->chassie }} name="chassie" type="text" class="form-control" id="chassie" placeholder="No Chassie">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select name="cylindre" id="cylindre" class="form-control" required id="cylindre">
                          <option value={{ $engin->cylindre }}>{{ $engin->cylindre }}</option>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          <input value={{ $engin->documentJustificatif }} name="documentJustificatif" type="file" class="custom-file-input" id="documentJustificatif">
