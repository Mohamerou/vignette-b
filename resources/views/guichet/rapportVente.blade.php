...
@page { margin: 0; }
	...
	<body>
		...
		<article>
			...
			<!-- <table class="meta">
				<tr>
					<th><span contenteditable>Rapport #</span></th>
			...
			<table class="inventory">
				...
				<tbody>
				@for($i=0; $i < count($data['SalesHistories']); $i++)
				<tr>
                <td>{{ $data['SalesHistories'][$i]['agent'] }}</td>
                <td>{{ $data['SalesHistories'][$i]['usager'] }}</td>
			...
			<table class="balance">
				<tr>
					...
					<td><span data-prefix></span><span>{{ $data['totalSales'] }} FCFA</span></td>
				</tr>
				<tr>
